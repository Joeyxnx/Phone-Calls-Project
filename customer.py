...
class Customer:
    ...
    def make_call(self, call: Call) -> None:
        ...
        for phone_num in self._phone_lines:
            if phone_num.number != call.src_number:
                pass
            else:
                phone_num.make_call(call)
    ...
    def receive_call(self, call: Call) -> None:
        ...
        for phone_num in self._phone_lines:
            if phone_num.number != call.dst_number:
                pass
            else:
                phone_num.receive_call(call)
