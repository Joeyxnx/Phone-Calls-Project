...
class CallHistory:
    ...
    def register_outgoing_call(self, call: Call) -> None:
        ...
        m = call.get_bill_date()[0]
        y = call.get_bill_date()[1]
        try:
            call_1 = self.outgoing_calls[(m, y)]
            call_1.append(call)
        except KeyError:
            self.outgoing_calls[(m, y)] = [call]
    ...
    def register_incoming_call(self, call: Call) -> None:
        ...
        y = call.get_bill_date()[1]
        try:
            call_2 = self.incoming_calls[(m, y)]
            call_2.append(call)
        except KeyError:
            self.incoming_calls[(m, y)] = [call]
